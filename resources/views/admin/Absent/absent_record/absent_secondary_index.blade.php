                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">#</th>
                                    <td>
                                    {{ $secondaryAbsents->studentProfile->last_name }},
                                    {{ $secondaryAbsents->studentProfile->first_name }}
                                    </td>
                                    <td>{{ $secondaryAbsents->SecondaryLevel->name }}</td>
                                    <td>{{ $secondaryAbsents->absent_type }}</td>
                                    <td>{{ $secondaryAbsents->quarter_name }}</td>
                                    <td class="text-center">{{ $secondaryAbsents->quarter_day_present }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('edit.secondarySchool.absentRecord', ['grade_id'=>$grade_id->id,'id'=>$students->id, 'secondaryAbsent_id'=>$secondaryAbsents->id]) }}"><span class="btn btn-sm btn-primary"> Edit </span></a>
                                    </td>
                                </tr>
                                @endforeach 
                                @endif
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ route('store.secondarySchool.absentRecord',['grade_id'=>$grade_id->id,'id'=>$students->id]) }}" method="post">
