        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>K and Pre-K Subject <small>setting</small></h3>
                </div>
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2> <i class="fa fa-sliders" aria-hidden="true"></i>  Edit subject for K and Pre-K</h2>
                        ...
                        <div class="x_content">
                            ...
                            {{--for edit form--}}
                            <div class="row">
                                <form action="{{ route('subject.prek.update', ['id'=>$subject->id]) }}" method="post">
                                    {{ csrf_field() }}
                                        ...
                                        <select name="grade_id" id="" class="form-control" required>
                                            @if(count($kgrade))
                                                @foreach($kgrade as $kgrades)
                                                    <option value="{{ $kgrades->id }}"
                                                            @if($subject->grade_id  == $kgrades->id) selected @endif
                                                    >{{ $kgrades->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
