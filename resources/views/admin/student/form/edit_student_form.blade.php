...
<div class="step1" style="margin-top: -30px">
    ...
    <div class="row">
        <div class="col-md-6 {{ $errors->has('father_name') ? ' has-error' : '' }}">
            ...
            <input type="text" name="father_name" class="form-control" value="{{ $student->father_name }}" required autofocus placeholder="Father's name" >
        </div>
        <div class="col-md-6 {{ $errors->has('career') ? ' has-error' : '' }}">
            <label for="occupation">Father's occupation</label>
            <input type="text" name="father_occupation" class="form-control" value="{{ $student->father_occupation }}" required autofocus placeholder="Father's occupation" >
        </div>
    ...
    <div class="row">
        <div class="col-md-6 {{ $errors->has('mother_name') ? ' has-error' : '' }}">
            ...
            <input type="text" name="mother_name" class="form-control" value="{{ $student->mother_name }}" required autofocus placeholder="mother name" >
        </div>
        <div class="col-md-6 {{ $errors->has('mother_occupation') ? ' has-error' : '' }}">
            <label for="occupation">Mother's occupation</label>
            <input type="text" name="mother_occupation" class="form-control" value="{{ $student->mother_occupation }}" required autofocus placeholder="mother's occupation" >
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 {{ $errors->has('father_phone') ? ' has-error' : '' }}">
            ...
            <input type="text" name="father_phone" class="form-control" value="{{ $student->father_phone }}" required autofocus placeholder="father phone" >
        </div>

        <div class="col-md-6 {{ $errors->has('mother_phone') ? ' has-error' : '' }}">
            <label for="mother_phone">Mother's mobile number</label>
            <input type="text" name="mother_phone" class="form-control" value="{{ $student->mother_phone }}" required autofocus placeholder="Mother phone" >
        </div>
