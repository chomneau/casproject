                                ...
                                <div class="x_panel">
                                  <div class="x_title">
                                    ...
                                    <div class="clearfix"></div>
                                      ...
                                      <form action="{{ route('teacher.highschool.transcript', ['student_id'=>$students->id]) }}" method="GET">
                                          {{ csrf_field() }}
                                            <div class="tab-content">
                          ...
                          {{--CGPA for Grade 9-10 Hight school--}}
                            <div class="col-md-3 col-sm-6 col-xs-12" style="margin-left: 13.5em">
                                <div class="x_panel">
                                    ...
                                    <form action="{{ route('teacher.transcript910', ['student_id'=>$students->id]) }}" method="GET">
                                        {{ csrf_field() }}
                                        <div class="tab-content">
                          ...
                          {{--CGPA for Grade 9-11 Hight school--}}
                            <div class="col-md-3 col-sm-6 col-xs-12 pull-right" style="margin-right: 39.5em">
                                <div class="x_panel">
                                    ...
                                    <form action="{{ route('teacher.transcript911', ['student_id'=>$students->id]) }}" method="GET">
                                        {{ csrf_field() }}
                                        <div class="tab-content">
                        ...
                        {{--CGPA for Hight school--}}
                            <div class="col-md-3 col-sm-6 col-xs-12 pull-right" style="margin-right: 27.5em">
                                <div class="x_panel">
                                    ...
                                    <form action="{{ route('teacher.cgpa.school', ['student_id'=>$students->id]) }}" method="GET">
                                        {{ csrf_field() }}
                                        <div class="tab-content">
                        ...
                        {{--CGPA for Hight school--}}
                            <div class="col-md-3 col-sm-6 col-xs-12 pull-right" style="margin-right: 15.5em">
                                <div class="x_panel">
                                    ...
                                    <form action="{{ route('teacher.transcript1011', ['student_id'=>$students->id]) }}" method="GET">
                                        {{ csrf_field() }}
                                        <div class="tab-content">
                        ...
                        {{--CGPA for Hight school--}}
                            <div class="col-md-3 col-sm-6 col-xs-12 pull-right" style="margin-right: 3.5em">
                                <div class="x_panel">
                                    ...
                                    <form action="{{ route('teacher.transcript1112', ['student_id'=>$students->id]) }}" method="GET">
                                        {{ csrf_field() }}
                                        <div class="tab-content">
                        ...
                        {{--CGPA for Hight school--}}
                            <div class="col-md-3 col-sm-6 col-xs-12 pull-right" style="margin-right: 10.5em">
                                <div class="x_panel">
                                    ...
                                    <form action="{{ route('teacher.transcript1012', ['student_id'=>$students->id]) }}" method="GET">
                                        {{ csrf_field() }}
                                        <div class="tab-content">
