...
@section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="row">
                <form role="form" class="form-group" action="{{ route('admin.staff.update', ['id'=>$staff->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel col-md-8 col-md-offset-2">
                        ...
                        <div class="container" style="margin-top: 1em">
                            ...
                            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" >
                                ...
                                <div class="col-md-8 col-md-offset-2" style="margin-bottom: 20px">
                                    <input id="name" type="text" class="form-control" name="first_name" value="{{ $staff->first_name }}" placeholder="First name" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" >
                                ...
                                <div class="col-md-8 col-md-offset-2" style="margin-bottom: 20px">
                                    <input id="name" type="text" class="form-control" name="last_name" value="{{ $staff->last_name }}" placeholder="Last name" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}" >
                                <label for="email" class="col-md-8 col-md-offset-2 control-label">E-Mail</label>
                                    ...
                                    <div class="col-md-8 col-md-8 col-md-offset-2" style="margin-bottom: 15px">
                                        <input id="email" type="email" class="form-control" name="email" value="{{ $staff->email }}" placeholder="Email address" required>
                                        ...
                                        <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}" >
                                            ...
                                            <div class="col-md-8 col-md-8 col-md-offset-2" style="margin-bottom: 15px">
                                                <input id="position" type="text" class="form-control" name="position" value="{{ $staff->position }}" placeholder="Position" required>
                                        ...
                                        <div class="form-group{{ $errors->has('degree') ? ' has-error' : '' }}" >
                                            ...
                                            <div class="col-md-8 col-md-8 col-md-offset-2" style="margin-bottom: 15px">
                                                <input id="degree" type="text" class="form-control" name="degree" value="{{ $staff->degree }}" placeholder="Degree" required>
                                        ...
                                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}" >
                                            ...
                                            <div class="col-md-8 col-md-8 col-md-offset-2" style="margin-bottom: 15px">
                                                <input id="phone" type="text" class="form-control" name="phone" value="{{ $staff->phone }}" placeholder="Phone number" required>
