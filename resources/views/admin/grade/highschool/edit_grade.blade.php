        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>High School <small>setting</small></h3>
                </div>
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2> <i class="fa fa-sliders" aria-hidden="true"></i>  Edit grade for high school</h2>
                        ...
                        <div class="row">
                            <form action="{{ route('grade.update', ['id'=>$grade->id]) }}" method="post">
                                ...
                                <div class="col-md-8 col-md-offset-1">
                                    ...
                                    <input type="text" name="grade" value="{{ $grade->grade_name }}" class="form-control" autofocus required>
                                    <br>
