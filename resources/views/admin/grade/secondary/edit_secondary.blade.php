        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Edit Secondary school grade Name <small>setting</small></h3>
                </div>
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2> <i class="fa fa-sliders" aria-hidden="true"></i>  Edit Grade for Secondary School</h2>
                        ...
                        {{--for edit form--}}
                        <div class="row">
                            <form action="{{ route('grade.secondary.update', ['id'=>$grade->id]) }}" method="post">
                                {{ csrf_field() }}
