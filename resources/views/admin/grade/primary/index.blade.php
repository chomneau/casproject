        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Primary | Grade Name <small>setting</small></h3>
                </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <a href="#" id="addCategory" class="btn btn-success" data-toggle="modal" data-target="#add-category">
                                Add new grade for Primary
                                <i class="glyphicon glyphicon-plus-sign"></i>
                            </a>
                            @include('admin.grade.primary.primary-form')
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                                ...
                                @if(count($grades))
                                    @foreach($grades as $grade)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('grade.primary.edit', ['id'=>$grade->id] ) }}" class="btn btn-primary btn-xs">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i> Edit
                                                </a>


                                                <a href="{{ route('grade.primary.delete', ['id'=>$grade->id]) }}" class="btn btn-danger btn-xs"
                                                   id="confirmation">
