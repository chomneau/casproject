        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Edit Grade Name <small>setting</small></h3>
                </div>
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2> <i class="fa fa-sliders" aria-hidden="true"></i>  Edit Grade for K and Prek</h2>
                            ...
                            @include('admin.grade.prek.prek-form')
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                        ...
                        {{--for edit form--}}
                        <div class="row">
                            <form action="{{ route('grade.prek.update', ['id'=>$grade->id]) }}" method="post">
                                {{ csrf_field() }}
                                <div class="col-md-8 col-md-offset-1">
                                    <label for="order">Grade Name</label>
