            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form role="form" class="form-group" action="{{ route('teacher.gradefile.update',['teacher_id'=>$teacher->id, 'gradefile_id'=>$gradefile->id]) }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                                    ...
                                                    <div class="step1" style="margin-top: -30px">
                                                        <div class="row">
                                                            <div class="col-md-12 {{ $errors->has('title') ? ' has-error' : '' }}">
                                                                ...
                                                                <input type="text" name="title" class="form-control" value="{{ $gradefile->title }}" autofocus id="title" placeholder="Title">
                                                            </div>
                                                            <div class="col-md-12 {{ $errors->has('description') ? ' has-error' : '' }}" style="margin-top: 20px">
                                                                <label for="description">Description</label>
                                                                <textarea name="description" class="form-control" id="" cols="30" rows="10">{{ $gradefile->description }}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 {{ $errors->has('grade_id') ? ' has-error' : '' }}" style="top:15px;left: 10px;padding-right: 18px;padding-left: 0px;">
                                                                ...
                                                                <select name="gradeProfile" id="" class="form-control" required>
                                                                    <option value="{{ $gradefile->gradeProfile->id }}">{{ $gradefile->gradeProfile->name }}</option>
                                                            ...
                                                            <div class="col-md-12 {{ $errors->has('file_name') ? ' has-error' : '' }}" style="margin-top: 20px">
                                                                <label for="logo">Upload Student Grade File (optional)</label>
                                                                <input type="file" name="file_name" class="form-control" value="{{ old('file_name') }}" autofocus placeholder="Grade file" >
                                                            </div>
                                                        </div>
